      ...
      Begin VB.Frame fraDevelopmentInner 
         ...
         Begin VB.Frame fraDefaultEditor 
            ...
            Begin VB.TextBox txtDefaultEditor 
               ...
               ToolTipText     =   $"frmPrefs.frx":3581
               Top             =   195
               Width           =   3660
            End
            Begin VB.Label lblDebug 
               Caption         =   $"frmPrefs.frx":3613
               Height          =   930
               Index           =   9
               Left            =   1545
               TabIndex        =   143
         ...
         Begin VB.ComboBox cmbDebug 
            Height          =   315
            ItemData        =   "frmPrefs.frx":374C
            Left            =   1530
            List            =   "frmPrefs.frx":374E
...
Private Sub fraConfigInner_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    If PrEnableTooltips = "1" Then CreateToolTip fraConfigInner.hwnd, "The configuration panel is the location for optional configuration items. These items change how Saturn operates, configure them to suit your needs and your mode of operation.", _
...
Private Sub fraConfig_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    If PrEnableTooltips = "1" Then CreateToolTip fraConfig.hwnd, "The configuration panel is the location for optional configuration items. These items change how Saturn operates, configure them to suit your needs and your mode of operation.", _
                  TTIconInfo, "Help on Configuration", , , , True
